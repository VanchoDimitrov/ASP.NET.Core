...
export class FetchEmployees extends React.Component<RouteComponentProps<{}>, FetchEmployeeDataState> {
    constructor() {
        super();
            ...
            <tbody>
                {empList.map(emp =>
                    <tr key={emp.employeeId}>
                        ...
                        <td>{emp.city}</td>
                        <td>
                            <a className="action" onClick={(id) => this.handleEdit(emp.employeeId)}><button type="button" className="btn btn-primary">Edit</button></a>  |
                            <a className="action" onClick={(id) => this.handleDelete(emp.employeeId)}><button type="button" className="btn btn-danger">Delete</button></a>
                        </td>
                    </tr>
                )}
            </tbody>
